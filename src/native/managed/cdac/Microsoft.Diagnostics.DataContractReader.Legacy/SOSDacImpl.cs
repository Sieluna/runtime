      ...
      ISOSDacInterface16, ISOSDacInterface17
{
    ...
    public SOSDacImpl(Target target, object? legacyObj)
        : this(target, legacyObj, new object())
    {
    }
    ...
    internal sealed unsafe partial class SOSHandleEnum : ISOSHandleEnum
    {
        ...
        public SOSHandleEnum(Target target, HandleType[] types, ISOSHandleEnum? legacyHandleEnum)
            : this(target, types, legacyHandleEnum, new object())
        {
        }

        internal SOSHandleEnum(Target target, HandleType[] types, ISOSHandleEnum? legacyHandleEnum, object apiLock)
        {
            _apiLock = apiLock;
            _target = target;
    ...
    internal sealed unsafe partial class SOSMemoryEnum : ISOSMemoryEnum
    {
        ...
        public SOSMemoryEnum(Target target, IReadOnlyList<GCMemoryRegionData> regions, ISOSMemoryEnum? legacyMemoryEnum = null)
            : this(target, regions, legacyMemoryEnum, new object())
        {
        }

        internal SOSMemoryEnum(Target target, IReadOnlyList<GCMemoryRegionData> regions, ISOSMemoryEnum? legacyMemoryEnum, object apiLock)
        {
            _apiLock = apiLock;
        ...
        public SOSMemoryEnum(SOSMemoryRegion[] regions, ISOSMemoryEnum? legacyMemoryEnum = null)
            : this(regions, legacyMemoryEnum, new object())
        {
        }

        internal SOSMemoryEnum(SOSMemoryRegion[] regions, ISOSMemoryEnum? legacyMemoryEnum, object apiLock)
        {
            _apiLock = apiLock;
            _regions = regions;
            _legacyMemoryEnum = legacyMemoryEnum;
    ...
    internal sealed unsafe partial class SOSStackRefEnum : ISOSStackRefEnum
    {
        ...
        internal SOSStackRefEnum(SOSStackRefData[] refs, object apiLock)
        {
            _apiLock = apiLock;
            _refs = refs;
        }
    ...
    internal sealed unsafe partial class SOSMethodEnum : ISOSMethodEnum
    {
        ...
        public SOSMethodEnum(Target target, ITypeHandle methodTable, ISOSMethodEnum? legacyMethodEnum)
            : this(target, methodTable, legacyMethodEnum, new object())
        {
        }

        internal SOSMethodEnum(Target target, ITypeHandle methodTable, ISOSMethodEnum? legacyMethodEnum, object apiLock)
        {
            _apiLock = apiLock;
            _target = target;
    ...
    internal sealed unsafe partial class SOSStressLogThreadEnum : ISOSStressLogThreadEnum
    {
        ...
        internal SOSStressLogThreadEnum(SOSThreadStressLogData[] threads, object apiLock)
        {
            _apiLock = apiLock;
            _threads = threads;
        }
    ...
    internal sealed unsafe partial class SOSStressLogMsgEnum : ISOSStressLogMsgEnum
    {
        ...
        public SOSStressLogMsgEnum(Target target, IEnumerable<Contracts.StressMsgData> messages)
            : this(target, messages, new object())
        {
        }

        internal SOSStressLogMsgEnum(Target target, IEnumerable<Contracts.StressMsgData> messages, object apiLock)
        {
            _apiLock = apiLock;
            _target = target;
