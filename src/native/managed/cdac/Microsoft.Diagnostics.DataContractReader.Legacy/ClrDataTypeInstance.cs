...
public sealed unsafe partial class ClrDataTypeInstance : IXCLRDataTypeInstance
{
    ...
    public ClrDataTypeInstance(Target target, ITypeHandle typeHandle, IXCLRDataTypeInstance? legacyImpl)
        : this(target, typeHandle, legacyImpl, new object())
    {
    }

    internal ClrDataTypeInstance(Target target, ITypeHandle typeHandle, IXCLRDataTypeInstance? legacyImpl, object apiLock)
    {
        _apiLock = apiLock;
        _target = target;
